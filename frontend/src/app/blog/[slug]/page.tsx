...
const comparisonRows = [
  {
    ...
    libreclip: "Open source and self-hostable. Your main costs are your own compute and API keys.",
    opusClip: "Free plan exists, but exports can include an OpusClip watermark.",
  },
  {
    icon: Sparkles,
    feature: "Clip discovery",
    libreclip: "Transcribes long videos, scores segments, and surfaces promising short-form moments.",
    opusClip: "AI clipping workflow built for finding social-ready clips from long videos.",
  },
  {
    icon: ScanFace,
    feature: "Vertical formatting",
    libreclip: "Face-centered 9:16 cropping, subtitles, and platform-ready exports.",
    opusClip: "Offers short-form exports and AI reframing for social platforms.",
  },
  {
    icon: Github,
    feature: "Control",
    libreclip: "Full source access, editable deployment, and no vendor lock-in.",
...
const faqs = [
  {
    ...
    answer:
      "LibreClip is a strong free OpusClip alternative if you want an open-source AI clip maker that you can self-host, customize, and run with your own video workflow.",
  },
  {
    icon: ShieldCheck,
    question: "Is LibreClip completely free?",
    answer:
      "The LibreClip codebase is free and open source. If you self-host it, you still need to account for your own infrastructure, transcription, and LLM provider costs.",
  },
  {
    icon: Captions,
    question: "Does LibreClip add a watermark?",
    answer:
      "LibreClip is designed for self-hosted control, so watermarking is not a forced platform limitation in the open-source workflow.",
  },
];
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-14 md:grid-cols-[1fr_0.42fr] md:py-20">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
                If you like the idea of OpusClip but want a free, open-source path, LibreClip gives
        ...
        <section className="mx-auto grid max-w-6xl gap-12 px-6 py-12 lg:grid-cols-[minmax(0,1fr)_280px] lg:py-16">
          <div className="min-w-0">
            <div className={articleBodyClassName}>
              ...
              <p>
                LibreClip is the best free OpusClip alternative for that specific creator: someone
                who wants AI-assisted clip discovery, vertical exports, captions, and control over
                the underlying system. You can also
                {" "}
                <a href={HOSTED_APP_URL} target="_blank" rel="noopener noreferrer">
                  try the hosted LibreClip product
                </a>
                {" "}
              ...
              <p>
                Choose LibreClip if you want an open-source AI video clipper you can self-host.
              ...
              <h2>What Makes LibreClip Different</h2>
              <p>
                LibreClip is not just a thin wrapper around a hosted editor. It is a complete
              ...
              <h2 id="libreclip-vs-opusclip">LibreClip vs OpusClip</h2>
            </div>
            ...
            <div className="my-8 overflow-hidden rounded-lg border">
              <div className="grid grid-cols-[0.85fr_1fr_1fr] bg-muted/50 text-sm font-semibold">
                ...
                <div className="border-l p-4">LibreClip</div>
              ...
              {comparisonRows.map(({ icon: Icon, ...row }) => (
                <div key={row.feature} className="grid grid-cols-[0.85fr_1fr_1fr] border-t text-sm">
                  ...
                  <div className="border-l p-4 leading-6 text-muted-foreground">{row.libreclip}</div>
            ...
            <div className={articleBodyClassName}>
              <h2>How LibreClip Works</h2>
              <ol>
                <li>Paste a YouTube URL or upload a video.</li>
                <li>LibreClip transcribes the source and finds candidate moments.</li>
              ...
              <h2>When LibreClip Is the Better Choice</h2>
              <p>
                LibreClip is best when you want a free OpusClip alternative with developer control.
            ...
            <section className="my-10 rounded-lg border bg-foreground p-6 text-background md:p-8">
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a href="https://github.com/puruhitaaa/libreclip" target="_blank" rel="noopener noreferrer">
            ...
            <section aria-labelledby="related-guides-heading">
              <h2 id="related-guides-heading" className="text-xl font-semibold">Related LibreClip guides</h2>
            ...
            <div className="sticky top-8 space-y-4">
              <div className="rounded-lg border p-5">
                ...
                <div className="mt-4 space-y-3 text-sm">
                  ...
                  <a href="#libreclip-vs-opusclip" className="block text-muted-foreground hover:text-foreground">
                    Comparison
                  </a>
              ...
              <div className="rounded-lg border bg-muted/35 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Use LibreClip when you want the clipping workflow without handing every decision
