...
This guide explains the visible parts of LibreClip and the main user flows.

## Product Summary

LibreClip turns long-form videos into short clips. Users can:
...
LibreClip uses Better Auth with an email and password flow backed by PostgreSQL through Prisma.
